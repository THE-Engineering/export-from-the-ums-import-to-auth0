...
then
  # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
  # Step 1 - Export users by date created (since $DATE_CREATED or $START) #
  # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

  echo "​"
  echo -e "\033[0;33mStep 1\033[0m \033[0;93mExport by date created and import to Auth0\033[0m"
  echo "​"
