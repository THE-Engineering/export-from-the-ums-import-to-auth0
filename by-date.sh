...
then
  ...
  echo -e 1>&2 " \033[0;31m•\033[0m \$SINCE"
...
then
  # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
  # Step 1 (a) - Export users by date changed (since $DATE_CHANGED or $START) #
  # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

  echo "​"
  echo -e "\033[0;33mStep 1 (a)\033[0m \033[0;93mExport by date changed and import to Auth0\033[0m"
  echo "​"

  echo -e "Exporting users from THE UMS \033[0;90mfor Step 1 (a)\033[0m"
  ...
  then
    ...
    if [[ $? == 0 ]];
    then
      echo -e "Importing users to Auth0 \033[0;90mfor Step 1 (a)\033[0m"
...
then
  # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
  # Step 1 (b) - Export users by date created (since $DATE_CREATED or $START) #
  # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

  echo "​"
  echo -e "\033[0;33mStep 1 (b)\033[0m \033[0;93mExport by date created and import to Auth0\033[0m"
  echo "​"

  echo -e "Exporting users from THE UMS \033[0;90mfor Step 1 (b)\033[0m"
  ...
  then
    ...
    echo -e "Transforming users \033[0;90mfor Step 1 (b)\033[0m"
    ...
    if [[ $? == 0 ]];
    then
      echo -e "Importing users to Auth0 \033[0;90mfor Step 1 (b)\033[0m"
