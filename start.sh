...
then
  ...
  echo "​"
  echo -e "\033[0;33mStep 1\033[0m \033[0;93mExport from THE UMS and import to Auth0\033[0m"
  echo "​"
  ...
  then
    ...
    then
      ...
      then
        ...
        echo "​"
        echo -e "\033[0;33mStep 2 (a)\033[0m \033[0;93mExport by date changed and import to Auth0\033[0m"
        echo "​"

        echo -e "Exporting users from THE UMS \033[0;90mfor Step 2 (a)\033[0m"
        ...
        then
          ...
          echo -e "Transforming users \033[0;90mfor Step 2 (a)\033[0m"
          ...
          if [[ $? == 0 ]];
          then
            echo -e "Importing users to Auth0 \033[0;90mfor Step 2 (a)\033[0m"
      ...
      then
        ...
        echo "​"
        echo -e "\033[0;33mStep 2 (b)\033[0m \033[0;93mExport by date created and import to Auth0\033[0m"
        echo "​"

        echo -e "Exporting users from THE UMS \033[0;90mfor Step 2 (b)\033[0m"
        ...
        then
          ...
          echo -e "Transforming users \033[0;90mfor Step 2 (b)\033[0m"
          ...
          if [[ $? == 0 ]];
          then
            echo -e "Importing users to Auth0 \033[0;90mfor Step 2 (b)\033[0m"
      ...
      then
        ...
        echo "​"
        echo -e "\033[0;33mStep 3\033[0m \033[0;93mValidate\033[0m"
        echo "​"
